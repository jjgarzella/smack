...
set_target_properties(clangBasic PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangBasic.so"
  IMPORTED_SONAME_DEBUG "libclangBasic.so"
  )
...
set_target_properties(clangLex PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangLex.so"
  IMPORTED_SONAME_DEBUG "libclangLex.so"
  )
...
set_target_properties(clangParse PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangParse.so"
  IMPORTED_SONAME_DEBUG "libclangParse.so"
  )
...
set_target_properties(clangAST PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangAST.so"
  IMPORTED_SONAME_DEBUG "libclangAST.so"
  )
...
set_target_properties(clangDynamicASTMatchers PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangDynamicASTMatchers.so"
  IMPORTED_SONAME_DEBUG "libclangDynamicASTMatchers.so"
  )
...
set_target_properties(clangASTMatchers PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangASTMatchers.so"
  IMPORTED_SONAME_DEBUG "libclangASTMatchers.so"
  )
...
set_target_properties(clangSema PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangSema.so"
  IMPORTED_SONAME_DEBUG "libclangSema.so"
  )
...
set_target_properties(clangCodeGen PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangCodeGen.so"
  IMPORTED_SONAME_DEBUG "libclangCodeGen.so"
  )
...
set_target_properties(clangAnalysis PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangAnalysis.so"
  IMPORTED_SONAME_DEBUG "libclangAnalysis.so"
  )
...
set_target_properties(clangEdit PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangEdit.so"
  IMPORTED_SONAME_DEBUG "libclangEdit.so"
  )
...
set_target_properties(clangRewrite PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangRewrite.so"
  IMPORTED_SONAME_DEBUG "libclangRewrite.so"
  )
...
set_target_properties(clangARCMigrate PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangARCMigrate.so"
  IMPORTED_SONAME_DEBUG "libclangARCMigrate.so"
  )
...
set_target_properties(clangDriver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangDriver.so"
  IMPORTED_SONAME_DEBUG "libclangDriver.so"
  )
...
set_target_properties(clangSerialization PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangSerialization.so"
  IMPORTED_SONAME_DEBUG "libclangSerialization.so"
  )
...
set_target_properties(clangRewriteFrontend PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangRewriteFrontend.so"
  IMPORTED_SONAME_DEBUG "libclangRewriteFrontend.so"
  )
...
set_target_properties(clangFrontend PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangFrontend.so"
  IMPORTED_SONAME_DEBUG "libclangFrontend.so"
  )
...
set_target_properties(clangFrontendTool PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangFrontendTool.so"
  IMPORTED_SONAME_DEBUG "libclangFrontendTool.so"
  )
...
set_target_properties(clangToolingCore PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangToolingCore.so"
  IMPORTED_SONAME_DEBUG "libclangToolingCore.so"
  )
...
set_target_properties(clangTooling PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangTooling.so"
  IMPORTED_SONAME_DEBUG "libclangTooling.so"
  )
...
set_target_properties(clangIndex PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangIndex.so"
  IMPORTED_SONAME_DEBUG "libclangIndex.so"
  )
...
set_target_properties(clangStaticAnalyzerCore PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangStaticAnalyzerCore.so"
  IMPORTED_SONAME_DEBUG "libclangStaticAnalyzerCore.so"
  )
...
set_target_properties(clangStaticAnalyzerCheckers PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangStaticAnalyzerCheckers.so"
  IMPORTED_SONAME_DEBUG "libclangStaticAnalyzerCheckers.so"
  )
...
set_target_properties(clangStaticAnalyzerFrontend PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangStaticAnalyzerFrontend.so"
  IMPORTED_SONAME_DEBUG "libclangStaticAnalyzerFrontend.so"
  )
...
set_target_properties(clangFormat PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclangFormat.so"
  IMPORTED_SONAME_DEBUG "libclangFormat.so"
  )
...
set_target_properties(libclang PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libclang.so.3.9"
  IMPORTED_SONAME_DEBUG "libclang.so.3.9"
  )
